...
class tt {
	...
	public function __construct(){
		...
		if($this->isURL){
			...
			$this->cachefile = $this->cacheDirectory . '/' . FILE_CACHE_PREFIX . $cachePrefix . md5($this->salt . $this->localImageMTime . implode('&',$arr) . $this->fileCacheVersion) . FILE_CACHE_SUFFIX;
		}
